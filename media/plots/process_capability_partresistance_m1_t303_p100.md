...
filtered_data_pc <- current_data[current_data$Machine == 1 & current_data$Temperature == 303 & current_data$Pressure == 100, ]
...
if (length(data_for_pc) > 0) {
  ...
  cat('\n--- Process Capability Metrics for PartResistance (M:1, T:303, P:100) ---\n')
  ...
  cat('Not enough valid numeric data for Process Capability for PartResistance (M:1, T:303, P:100).\n')
}
